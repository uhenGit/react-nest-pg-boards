...
const BoardContainer = observer(() => {
  const { board, updateBoard, deleteBoard } = BoardStore;
      ...
      <div className='d-flex border mb-2'>
        {
          ...
          ? <form className='mx-2 my-0 col-sm-10'>
              ...
              <button
                type='submit'
                onClick={ onSaveBoard }
                disabled={ boardName.trim() === '' || boardName.trim() === board.boardName }
        ...
        <div className='my-2'>
          <button
            ...
            className='btn btn-info rounded-circle btn-sm me-2'
          >
            <svg
          ...
          <button
            ...
            className='btn btn-danger rounded-circle btn-sm my-2'
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="12"
